...
public class RDOSpeedSelectionToolbar extends
	...
	public static void setSpeed(int val) {
		speedValue = val < RDOSpeedSelector.MIN ? RDOSpeedSelector.MIN
				: val > RDOSpeedSelector.MAX ? RDOSpeedSelector.MAX : val;
	}
		...
		public RDOSpeedSelector(Composite parent, int style) {
			...
			addMouseListener(new MouseListener() {
				...
				public void mouseDown(MouseEvent e) {
					if (e.button == 1)
						RDOSpeedSelector.this.setSpeed(e.x,
								RDOSpeedSelector.this.getSize().x);
				}
