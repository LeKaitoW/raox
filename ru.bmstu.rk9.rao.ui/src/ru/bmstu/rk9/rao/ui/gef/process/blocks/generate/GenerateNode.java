package ru.bmstu.rk9.rao.ui.gef.process.blocks.generate;
...
public class GenerateNode extends BlockNode {
	...
	public BlockConverterInfo createBlock(ModelContentsInfo modelContentsInfo) {
		...
		ru.bmstu.rk9.rao.lib.process.Generate generate = new ru.bmstu.rk9.rao.lib.process.Generate(ID, () -> interval);
