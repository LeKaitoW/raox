...
public interface AnimationContext {
	...
	public void drawText(String text, int x, int y, RaoColor textColor, int width,
			Alignment alignment);

	public void drawText(String text, int x, int y, RaoColor textColor);

	public void drawRectangle(int x, int y, int width, int height,
			RaoColor backgroundColour, RaoColor borderColour);

	public void drawLine(int x1, int y1, int x2, int y2, RaoColor lineColour);

	public void drawCircle(int x, int y, int radius, RaoColor backgroundColour,
